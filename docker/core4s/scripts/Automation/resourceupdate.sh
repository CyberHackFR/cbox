...
mv -f IP2LOCATION-LITE-DB5.BIN /core4s/workfolder/var/lib/cbox/IP2LOCATION-LITE-DB5.BIN
unzip -o IP2LOCATION-LITE-DB5.IPV6.BIN.zip
mv -f IP2LOCATION-LITE-DB5.IPV6.BIN /core4s/workfolder/var/lib/cbox/IP2LOCATION-LITE-DB5.IPV6.BIN
